...
* `file_name` - name of the file to store general keys accessible in all environments. Default: `'settings'`
* `dir_name` - name of the directory to store environment-specific files. Default: `'settings'`
