...
For Ruby `2.0` to `2.3` or Rails `3` to `4.1` use version `1.x` of this gem. For Rails `4.2`, use version `2.x` of this gem. For older versions of Rails or Ruby use [AppConfig](http://github.com/fredwu/app_config).
